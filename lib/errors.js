...
var prettyPrintError = function (message) { return function (actual, expected, longError) {
    ...
    var diffString2 = jest_diff_1.default(typeof actual === 'string' ? actual : removeGrandchildren(actual), typeof expected === 'string' ? expected : wildcard_1.isWildcard(expected)
        ? 'WILDCARD'
